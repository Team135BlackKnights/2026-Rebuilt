...
public class FrontRollers extends GenericRollerSystem<FrontRollers.Goal> {
    ...
    public enum Goal implements GenericRollerSystem.RollGoalSupplier {
        STOPPED(() -> 0),
        IDLING(new LoggableTunedNumber("Intake/FrontRollers/IdlingVoltage", 0.0, Constants.TuningConstants.isTuningIntake)),
        INTAKING(
                new LoggableTunedNumber("Intake/FrontRollers/IntakingVoltage", 8.0, Constants.TuningConstants.isTuningIntake)),
        SHOOTING(new LoggableTunedNumber("Intake/FrontRollers/ShootingVoltage", 10.0, Constants.TuningConstants.isTuningIntake)),
        VOMITING(new LoggableTunedNumber("Intake/FrontRollers/VomitingVoltage",-6.0,Constants.TuningConstants.isTuningIntake)),
        JACKHAMMER_IN(new LoggableTunedNumber("Intake/FrontRollers/JackhammerInAmps", 20.0, Constants.TuningConstants.isTuningIntake),
                () -> false),
        JACKHAMMER_OUT(new LoggableTunedNumber("Intake/FrontRollers/JackhammerOutAmps", -20.0, Constants.TuningConstants.isTuningIntake),
                () -> false);
