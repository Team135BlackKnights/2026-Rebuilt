package frc.robot.utils.CompetitionFieldUtils.Simulation.Rebuilt;
...
public class Arena2026Rebuilt extends SimulatedArena {
     ...
     */
    public Arena2026Rebuilt(AbstractDriveTrainSimulation mainRobot) {
        this(true, mainRobot);
    }
     ...
     */
    public Arena2026Rebuilt(boolean AddRampCollider, AbstractDriveTrainSimulation mainRobot) {
        super(new RebuiltFieldObstaclesMap(AddRampCollider), mainRobot);
