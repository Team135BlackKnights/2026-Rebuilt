...
public class IntakeSimulation extends BodyFixture {
    ...
    public final class GamePieceContactListener implements ContactListener<Body> {
        @Override
        public void begin(@SuppressWarnings("rawtypes") ContactCollisionData collision, Contact contact) {
            if (!intakeRunning) return;
        ...
        /* functions not used */
        @Override
        public void persist(@SuppressWarnings("rawtypes") ContactCollisionData collision, Contact oldContact, Contact newContact) {}

        @Override
        public void end(@SuppressWarnings("rawtypes") ContactCollisionData collision, Contact contact) {}

        @Override
        public void destroyed(@SuppressWarnings("rawtypes") ContactCollisionData collision, Contact contact) {}

        @Override
        public void collision(@SuppressWarnings("rawtypes") ContactCollisionData collision) {}

        @Override
        public void preSolve(@SuppressWarnings("rawtypes")  ContactCollisionData collision, Contact contact) {}

        @Override
        public void postSolve(@SuppressWarnings("rawtypes") ContactCollisionData collision, SolvedContact contact) {}
    }
    ...
    public void register() {
        register(RobotContainer.fieldSimulation);
    }
