...
public class AdvancedMechanismConstants {
        public static class Turret {
                public static final double leftMinTurretAngle = -Math.PI / 2.0;
                public static final double leftMaxTurretAngle = Math.PI / 2.0;
                public static final double rightMinTurretAngle = -Math.PI / 2.0;
                public static final double rightMaxTurretAngle = Math.PI / 2.0;
