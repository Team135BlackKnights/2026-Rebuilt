...
public class AdvancedMechanismConstants {
        public static class Turret {
                ...
                // Right Turret
                public static final int rightAzimuthID = 28;
                public static final int rightAzimuthBigEncoderID = 29;
                public static final int rightAzimuthSmallEncoderID = 30;
                public static final int rightFlywheelID = 31;
                public static final int rightHoodID = 32;
                public static final int rightHoodEncoderID = 33;
