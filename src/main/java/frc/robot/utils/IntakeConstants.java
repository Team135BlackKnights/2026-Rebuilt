...
public class IntakeConstants {
    ...
    public static final double armMinAngleDeg = 0.0;
    public static final double armMaxAngleDeg = 135.0;
    public static final double armDegreesPerMechanismRotation = 360.0;
