...
import frc.robot.utils.YAMS.controllers.ExponentialProfilePIDController;
import frc.robot.utils.YAMS.controllers.LQRController;
...
public class SmartMotorControllerConfig
{
  ...
  public SmartMotorControllerConfig withExternalEncoderZeroOffset(Distance distance)
  {
    ...
    {
      throw new IllegalArgumentException("Mechanism circumference is undefined");
    }
  ...
  public SmartMotorControllerConfig withContinuousWrapping(Angle bottom, Angle top)
  {
    ...
    {
      throw new IllegalArgumentException("Soft limits set while configuring continuous wrapping");
    }
    if (linearClosedLoopController)
    {
      throw new IllegalArgumentException("Distance based mechanism used with continuous wrapping"); 
    }
    pid.ifPresent(pidController -> pidController.enableContinuousInput(bottom.in(Rotations),
                                                                       top.in(Rotations)));
    if (pid.isEmpty())
    {
      throw new IllegalArgumentException("No PID controller used");
    }
  ...
  public SmartMotorControllerConfig withClosedLoopTolerance(Distance tolerance)
  {
    if (!linearClosedLoopController)
    {
      throw new IllegalArgumentException("Linear closed loop controller used with distance tolerance.");
    }
    if (tolerance != null)
    {
  ...
  public SmartMotorControllerConfig withMomentOfInertia(Distance length, Mass weight)
  {
    ...
    {
      throw new IllegalArgumentException("Length or Weight cannot be null");
    } else
    {
...
//    basicOptions.remove(BasicOptions.MomentOfInertia);
  ...
  public Optional<Angle> getMaxDiscontinuityPoint()
  {
    ...
    {
      throw new IllegalArgumentException("Bounds are not correct! Cannot get the discontinuity point. " +
...
//    basicOptions.remove(BasicOptions.DiscontinuityPoint);
  ...
  public void validateBasicOptions()
  {
    if (!basicOptions.isEmpty())
    {
      ...
      throw new IllegalArgumentException("Basic options are not applied. Cannot validate basic options.");
    }
  }
  ...
  public void validateExternalEncoderOptions()
  {
    if (!externalEncoderOptions.isEmpty())
    {
      ...
      throw new IllegalArgumentException("External encoder options are not applied. Cannot validate external encoder options.");
    }
  }
