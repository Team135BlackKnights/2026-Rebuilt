package frc.robot.utils.YAMS.mechanisms;
...
public class FlyWheelConfig
{
  ...
  /**
   * Mechanism position configuration for the {@link frc.robot.utils.YAMS.mechanisms.Pivot} (Optional).
   */
  ...
  public FlyWheelConfig withSmartMotorController(SmartMotorController motorController)
  {
    if (motor.isPresent())
    {
      throw new IllegalArgumentException("FlyWheel SmartMotorController already set!"); 
    }
  ...
  public FlyWheelConfig withSpeedometerSimulation()
  {
    ...
    {
      throw new IllegalArgumentException("Speedometer max velocity is not set.");
    }
    this.useSpeedometer = true;
    return this;
  }
  ...
  public double getMOI()
  {
    ...
    throw new IllegalArgumentException("FlyWheel diameter and weight or MOI must be set!");
  }
  ...
  public Distance getCircumference()
  {
    if (diameter.isEmpty())
    {
      throw new IllegalArgumentException("FlyWheel diameter is empty");
    }
