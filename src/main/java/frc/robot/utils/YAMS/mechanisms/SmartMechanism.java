...
public abstract class SmartMechanism
{
  ...
  {
    return Commands.startRun(m_smc::stopClosedLoopController, () -> m_smc.setDutyCycle(dutycycle))
  ...
  public Command set(Supplier<Double> dutycycle)
  {
    return Commands.startRun(m_smc::stopClosedLoopController,
                             () -> m_smc.setDutyCycle(dutycycle.get()))
                   .finallyDo(m_smc::startClosedLoopController)
                   .withName(" SetDutyCycle Supplier");
  }
  ...
  {
    return Commands.startRun(m_smc::stopClosedLoopController, () -> m_smc.setVoltage(volts.get()))
                   .finallyDo(m_smc::startClosedLoopController)
                   .withName(" SetVoltage Supplier");
  }
