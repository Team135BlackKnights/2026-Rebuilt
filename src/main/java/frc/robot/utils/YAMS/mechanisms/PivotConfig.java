...
import frc.robot.utils.YAMS.SmartMotorControllerConfig.TelemetryVerbosity;
...
public class PivotConfig
{
  ...
  public PivotConfig withSmartMotorController(SmartMotorController motorController)
  {
    if (motor.isPresent())
    {
      throw new IllegalArgumentException("Pivot SmartMotorController already set!");
    }
  ...
  public double getMOI()
  {
    ...
    throw new IllegalArgumentException("Pivot MOI must be set!");
  }
